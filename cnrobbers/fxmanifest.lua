...
dependencies {'spawnmanager', 'oxmysql'}
...
shared_scripts {"config.lua", "lib/shared/*.lua","shared/*.lua", "lang/shared/*.lua"}
client_scripts {"lib/client/*.lua","lang/client/*.lua","ent_enum.lua","client/*.lua"}
server_scripts {"@oxmysql/lib/MySQL.lua", "lib/server/*.lua","lang/server/*.lua","server/*.lua"}
